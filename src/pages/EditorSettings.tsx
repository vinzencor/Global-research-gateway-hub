          ...
          <div className="rounded-xl border bg-card p-6 card-shadow">
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-primary text-primary-foreground text-xl font-bold shrink-0">
                {user?.profile?.full_name?.charAt(0)?.toUpperCase() || user?.email?.charAt(0)?.toUpperCase() || "E"}
              </div>
              <div>
                <p className="font-heading font-bold text-lg">{user?.profile?.full_name || "Editor"}</p>
